	...
	class acf_ngmdl_shortcode {
		...
		*/
		public function acf_ngmdl_do_shortcode($atts){
			...
			$return .= "<div id='map_sidebar' class='map_sidebar'><div class='acf_map_marker'><div class='acf_ngmdl' style='width: ".$width_px."; height: ".$height_px."'><div class='TopLeft'><span id='triggermap' class=''></span></div>
		...
		*/
		public function acf_ngmdl_googlemap_initialize(){
			...
			$return .= "<div id='map_canvas' class='acf-map'>".$marker_instances."</div>
			<input type='hidden' id='maps_found' value='".$found."'>";

...
*  @created: 21/09/14
*/
if (!class_exists('acf_ngmdl_plugin')){
	class acf_ngmdl_plugin {
		/*
		*  Construct
		*
		*  @description: 
		...
		*/
		...
		function __construct() {
			...
			// Actions
			add_action( 'init', array( $this, 'acf_ngmdl_plugin_install') );
		...
		*/
		...
		/*
		*  acf_ngmdl_plugin_uninstall
		*
		*  @description: Plugin Uninstall. Removes all the data associate to this plugin.
		*  @since: 1.0
		*  @created: 21/09/14
		*/
		public static function acf_ngmdl_plugin_uninstall(){
		...
		*/
		public function acf_ngmdl_do_shortcode(){		
			$acf_ngmdl_shortcode = new acf_ngmdl_plugin_shortcode();
		}

	}

	// Init
	$acf_ngmdl = new acf_ngmdl_plugin();
}

// Uninstall hook
register_uninstall_hook( __FILE__ , array( 'acf_ngmdl_plugin', 'acf_ngmdl_plugin_uninstall' ) );
